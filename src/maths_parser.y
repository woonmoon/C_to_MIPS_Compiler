...
%type <expr> POSTFIX_EXPRESSION UNARY_EXPRESSION
%type <expr> EXPR TERM UNARY FACTOR
%type <expr> PRIMARY_EXPRESSION EXPRESSION ASSIGNMENT_EXPRESSION CAST_EXPRESSION
...
%type <actualExpression> CONSTANT_EXPRESSION
...
DIRECT_DECLARATOR : T_IDENTIFIER  { $$ = new Identifier(*$1); }
                  ...
                  | DIRECT_DECLARATOR T_LSQUARE T_RSQUARE { $$ = new arrayDeclaration($1, NULL); }
                  ;
