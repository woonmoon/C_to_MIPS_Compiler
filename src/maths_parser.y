...
%token T_IF T_ELSE T_WHILE T_RETURN T_INT T_VOID T_STRUCT T_UNION T_ENUM T_CONTINUE T_BREAK T_FOR T_SWITCH
%token T_ASSIGN T_PLUS_EQ T_MINUS_EQ T_TIMES_EQ T_DIV_EQ T_MOD_EQ T_AND_EQ T_OR_EQ T_XOR_EQ T_LSHIFT_EQ T_RSHIFT_EQ
%token T_CONSTANT T_IDENTIFIER T_TYPEDEF T_CONST T_VOLATILE T_PLUS_PLUS T_MINUS_MINUS T_CASE T_DEFAULT
...
%type <expr> DIRECT_DECLARATOR PARAMETER_DECLARATION ABSTRACT_DECLARATOR DIRECT_ABSTRACT_DECLARATOR
...
%type <exprList> ARGUMENT_EXPRESSION_LIST STRUCT_DECLARATOR_LIST TRANSLATION_UNIT POINTER
