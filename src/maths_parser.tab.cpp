...
#line 126 "src/maths_parser.tab.cpp"
...
#line 190 "src/maths_parser.tab.cpp"
...
#line 1596 "src/maths_parser.tab.cpp"
    break;

  case 3:
#line 62 "src/maths_parser.y"
                                { (yyval.expr) = new Constant((yyvsp[0].number)); std::cout << "issa constant" << std::endl;}
#line 1602 "src/maths_parser.tab.cpp"
    break;

  case 4:
#line 63 "src/maths_parser.y"
                                                      { std::cout << "lbr rbr" << std::endl; }
#line 1608 "src/maths_parser.tab.cpp"
    break;

  case 5:
#line 65 "src/maths_parser.y"
                                        {(yyval.expr) = (yyvsp[0].expr);}
#line 1614 "src/maths_parser.tab.cpp"
    break;

  case 10:
#line 72 "src/maths_parser.y"
                                      {(yyval.expr) = (yyvsp[0].expr);}
#line 1620 "src/maths_parser.tab.cpp"
    break;

  case 12:
#line 75 "src/maths_parser.y"
                        { std::cout << "* found" << std::endl; }
#line 1626 "src/maths_parser.tab.cpp"
    break;
...
#line 146 "src/maths_parser.y"
                                       { (yyval.expr) = (yyvsp[0].expr); std::cout << "init declarator list: init declarator" << std::endl; }
...
#line 150 "src/maths_parser.y"
                             {(yyval.expr) = new initDeclarator((yyvsp[0].expr)); std::cout << "init declarator: declarator" << std::endl; }
#line 1854 "src/maths_parser.tab.cpp"
    break;

  case 51:
#line 151 "src/maths_parser.y"
                                                  { (yyval.expr) = new initDeclarator((yyvsp[-2].expr), (yyvsp[0].expr)); std::cout << "init declarator: declarator = initializer" << std::endl; }
...
#line 157 "src/maths_parser.y"
                        { (yyval.expr) = new PrimitiveType(PrimitiveType::Specifier::_void); std::cout << "type specifier: void" << std::endl; }
#line 1872 "src/maths_parser.tab.cpp"
    break;

  case 54:
#line 158 "src/maths_parser.y"
                       {(yyval.expr) = new PrimitiveType(PrimitiveType::Specifier::_int); std::cout << "type specifier: int" << std::endl;}
