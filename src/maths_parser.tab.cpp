...
#line 218 "src/maths_parser.y" /* yacc.c:1646  */
    { (yyval.expr) = new functionDec((yyvsp[-3].expr), (yyvsp[-1].exprList)); std::cout << "direct declarator: direct declarator ( parameter type list )" << std::endl; std::cout << RED << "new functiondec with direct delcarator and parameter type list" << RESET << std::endl; }
#line 1939 "src/maths_parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 76:
#line 219 "src/maths_parser.y" /* yacc.c:1646  */
    { (yyval.expr) = new functionDec((yyvsp[-3].expr), (yyvsp[-1].exprList)); delete (yyvsp[-1].exprList); std::cout << "direct declarator: direct declarator ( identifier list )" << std::endl; std::cout << RED << "new functiondec with direct delcarator and identifier list" << RESET << std::endl; }
