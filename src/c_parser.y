...
%token T_SEMICOLON T_SHORT T_SIGNED T_SLASH T_STAR T_STATIC T_STRING_LITERAL T_STRUCT T_SUB_ASSIGN T_SWITCH T_TILDE
%token T_TYPEDEF T_TYPE_NAME T_UNION T_UNSIGNED T_VOID T_VOLATILE T_XOR_ASSIGN
